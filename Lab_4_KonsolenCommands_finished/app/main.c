...
// lists the content of the named file in the indicated drive
int Cmd_cat(int argc, char *argv[])
{
    char *drive;
    char *filename, *file_path, *content;
    FILE *Fptr;
    
    drive = argv[1];
    filename = argv[2];
    file_path = strcat(drive, filename);
    ...
    if(Fptr != 0){
        ...
        //stores content
        fgets(content, strlen(filename), Fptr);
